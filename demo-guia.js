...
(function(){
  ...
  function estilos(){
    ...
    s.textContent = [
      ...
      '.demo-hero{position:relative;overflow:hidden;padding:20px;border-radius:25px;color:#fff;background:linear-gradient(135deg,#0b5878 0%,#128C7E 56%,#3ad0a4 115%);box-shadow:0 18px 40px rgba(70,72,170,.24)}',
