...
'use strict';
  ...
  function css(){
    ...
    st.textContent = [
      ...
      '.agenda-switch button.activo{background:linear-gradient(135deg,#0b5878,#3ad0a4);border-color:transparent;color:#fff;box-shadow:0 8px 20px rgba(91,112,210,.24)}',
      ...
      '.ap-link.pasar,.ap-link.ver{background:linear-gradient(135deg,#0b5878,#3ad0a4);color:#fff}',
      ...
      '.ap-bulk-badge{display:inline-grid;place-items:center;min-width:22px;height:22px;padding:0 6px;border-radius:999px;background:linear-gradient(135deg,#0b5878,#3ad0a4);color:#fff;font-size:11px;font-weight:900}',
      ...
      '.ap-bulk-btn.pasar{background:linear-gradient(135deg,#0b5878,#3ad0a4);color:#fff;box-shadow:0 6px 14px rgba(91,112,210,.22)}',
