/* ============================================================
   ...
   Listado (v403): mismas tarjetas de vidrio que el resto de APPI.
   Agrupado por letra. Un puntito a la derecha marca a quien ya
   está en la Agenda APPI. Las acciones aparecen al tocar el nombre.
...
'use strict';
  ...
  function css(){
    ...
    st.id = 'apEstilos';
    st.textContent = [
      '.agenda-switch{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin:13px 0 10px}',
      '.agenda-switch button{min-height:46px;border:1px solid rgba(255,255,255,.75);border-radius:16px;background:rgba(255,255,255,.68);font:inherit;font-size:12px;font-weight:850;color:#5c5c68;cursor:pointer;padding:6px 8px;box-shadow:0 6px 16px rgba(68,76,118,.06)}',
      '.agenda-switch button.activo{background:linear-gradient(135deg,#5b8def,#8b63e8);border-color:transparent;color:#fff;box-shadow:0 8px 20px rgba(91,112,210,.24)}',
      'body.dark .agenda-switch button{background:rgba(30,30,50,.62);border-color:rgba(255,255,255,.08);color:#c9c9d6}',
      'body.dark .agenda-switch button.activo{color:#fff}',
      '.ap-cabeza{margin:8px 0 10px}',
      '.ap-cabeza h3{margin:0;font-size:22px;font-weight:900;letter-spacing:-.4px;color:#282837}',
      'body.dark .ap-cabeza h3{color:#f2f2f7}',
      '.ap-cabeza small{display:block;margin-top:4px;color:#777887;font-size:12.5px;font-weight:700}',
      '.ap-import{display:flex;flex-wrap:wrap;gap:8px;margin:8px 0 10px}',
      '.ap-import button{flex:0 0 auto;width:auto;min-height:32px;border:0;border-radius:12px;font:inherit;font-size:11px;font-weight:850;cursor:pointer;padding:6px 11px;line-height:1.2}',
      ...
      '.ap-import .guia{background:rgba(80,90,130,.08);border:0;color:#6b6e82}',
      'body.dark .ap-import .ppal,body.dark .ap-import .otro{background:rgba(91,141,239,.22);color:#9db9f7}',
      'body.dark .ap-import .guia{background:rgba(255,255,255,.06);color:#b7b3c9}',
      '.ap-buscar{width:100%;min-height:44px;margin:8px 0 10px;padding:10px 14px;border:1.5px solid rgba(80,90,130,.14);border-radius:14px;background:rgba(255,255,255,.88);font:inherit;font-size:15px;outline:none;box-sizing:border-box;color:#282837}',
      '.ap-buscar:focus{border-color:#5b8def;box-shadow:0 0 0 3px rgba(91,141,239,.14)}',
      'body.dark .ap-buscar{background:rgba(29,31,49,.88);border-color:rgba(255,255,255,.12);color:#f2f2f7}',
      '.ap-toolbar{display:flex;align-items:center;justify-content:space-between;gap:6px;flex-wrap:wrap;margin:4px 0 12px;padding:0;font-size:12.5px;color:#777887;font-weight:750;user-select:none}',
      ...
      '.ap-elegir.activa{background:linear-gradient(135deg,#5b8def,#8b63e8);color:#fff}',
      'body.dark .ap-elegir{background:rgba(91,141,239,.18);color:#a8c0ff}',
      '.ap-letra{margin:16px 4px 8px;padding:0;font-size:12px;font-weight:900;color:#3d63c9;letter-spacing:.8px;text-transform:uppercase}',
      'body.dark .ap-letra{color:#a8c0ff}',
      '.ap-item{margin:0 0 8px;border-radius:16px;background:rgba(255,255,255,.68);border:1px solid rgba(255,255,255,.84);box-shadow:0 6px 16px rgba(68,76,118,.06);overflow:hidden}',
      'body.dark .ap-item{background:rgba(30,32,50,.62);border-color:rgba(255,255,255,.08)}',
      '.ap-row{display:flex;align-items:center;gap:12px;width:100%;box-sizing:border-box;padding:12px 14px;border:0;border-radius:0;background:transparent;text-align:left;cursor:pointer}',
      'body.dark .ap-row{background:transparent}',
      '.ap-item.seleccionado{box-shadow:inset 0 0 0 1.5px rgba(91,141,239,.5),0 6px 16px rgba(68,76,118,.06)}',
      '.ap-punto{width:8px;height:8px;margin-left:auto;flex:0 0 auto;border-radius:50%;background:#3ad0a4;box-shadow:0 0 0 3px rgba(58,208,164,.16)}',
      '.ap-punto.ap-punto-off{background:transparent;box-shadow:none}',
      '.ap-check-label{display:none;align-items:center;cursor:pointer;flex:0 0 auto;margin:0;padding:0}',
      '.ap-modo .ap-check-label{display:inline-flex}',
      '.ap-check{width:16px;height:16px;cursor:pointer;accent-color:#5b8def}',
      '.ap-row .ap-quien{flex:1;min-width:0}',
      '.ap-row .ap-quien b{display:block;color:#282837;font-size:15.5px;font-weight:850;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}',
      'body.dark .ap-row .ap-quien b{color:#f2f2f7}',
      '.ap-row .ap-quien small{color:#777887;font-size:12.5px;font-weight:650;display:block;margin-top:2px}',
      '.ap-sr{position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0,0,0,0)}',
      '.ap-card-actions{display:flex;flex-wrap:wrap;align-items:center;gap:8px;padding:0 12px 12px}',
      'body.dark .ap-card-actions{border:0}',
      '.ap-link{background:rgba(91,141,239,.12);border:0;padding:8px 12px;border-radius:999px;font:inherit;font-size:12px;font-weight:850;cursor:pointer;color:#3d63c9;text-decoration:none}',
      '.ap-link.wa{background:rgba(37,211,102,.14);color:#128c7e}',
      '.ap-link.pasar,.ap-link.ver{background:linear-gradient(135deg,#5b8def,#8b63e8);color:#fff}',
      '.ap-link.borrar{background:rgba(222,69,78,.12);color:#c34c53}',
      '.ap-link.call{color:#3d63c9}',
      '.ap-bulk-bar{position:sticky;bottom:14px;z-index:99;display:flex;align-items:center;justify-content:space-between;gap:8px;padding:12px 14px;margin:18px 0 6px;border:1px solid rgba(255,255,255,.85);border-radius:18px;background:rgba(255,255,255,.82);color:#282837;backdrop-filter:blur(18px);box-shadow:0 8px 24px rgba(68,76,118,.12)}',
      'body.dark .ap-bulk-bar{background:rgba(24,26,42,.88);border-color:rgba(255,255,255,.1);color:#f2f2f7}',
      '.ap-bulk-info{display:flex;align-items:center;gap:7px;font-size:13px;font-weight:750}',
      '.ap-bulk-badge{display:inline-grid;place-items:center;min-width:22px;height:22px;padding:0 6px;border-radius:999px;background:linear-gradient(135deg,#5b8def,#8b63e8);color:#fff;font-size:11px;font-weight:900}',
      '.ap-bulk-actions{display:flex;align-items:center;gap:8px;flex-wrap:wrap}',
      '.ap-bulk-btn{height:auto;padding:8px 12px;border:0;border-radius:12px;background:rgba(91,141,239,.12);font:inherit;font-size:12px;font-weight:850;cursor:pointer;display:inline-flex;align-items:center;gap:4px;color:#3d63c9}',
      '.ap-bulk-btn.pasar{background:linear-gradient(135deg,#5b8def,#8b63e8);color:#fff;box-shadow:0 6px 14px rgba(91,112,210,.22)}',
      '.ap-bulk-btn.borrar{background:rgba(222,69,78,.12);color:#c34c53}',
      '.ap-bulk-btn.cancelar{background:rgba(80,90,130,.08);color:#777887;width:auto;justify-content:center}',
      ...
      '.ap-vacio{padding:22px 16px;border-radius:16px;background:rgba(255,255,255,.5);border:1px dashed rgba(91,141,239,.28);text-align:left;color:#777887;font-size:14px;line-height:1.55}',
      '.ap-vacio .ico{display:none}',
      '.ap-aviso{margin:8px 0 12px;padding:12px 14px;border-radius:14px;background:rgba(245,179,1,.10);border:1px solid rgba(245,179,1,.22);color:#8a6116;font-size:12.5px;line-height:1.45}'
    ].join('\n');
