...
begin
  ...
  -- Evita acumular invitaciones abiertas indefinidamente. El alias es
  -- obligatorio: `expires_at` también es una columna de salida declarada en
  -- `returns table(...)` y sin calificar Postgres aborta con 42702.
  update public.appi_encuesta_invitaciones as vigente
  set revoked_at = now(), updated_at = now()
  where vigente.user_id = owner_id
...
-- ============================================================
-- 7. Puente entre PC/tablet y teléfono
-- ============================================================
...
-- ============================================================================
-- APPI · MEMBRESÍAS, PRÓRROGAS Y PAGOS (v250)
-- ============================================================================
