...
(function () {
  ...
  function pintar(){
    try{ var h=document.querySelector('#view-tumes header.top p'); if(h && h.textContent==='Las cartas de cada día') h.innerHTML='Las cartas de cada día <span class="renewed-badge">✨ Renovada 721</span>'; }catch(e){}
    css();
