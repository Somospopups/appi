...
(function(){
  ...
  function render(){
    ...
    var state = cargar(), n = total(state);
      ...
      return '<button type="button" class="mg-petal ' + (count ? 'has-contacts' : '') + '" style="transform:rotate(' + (i * 45) + 'deg);--angle:' + (i * 45) + 'deg;--counter:-' + (i * 45) + 'deg;--i:' + i + '" data-mg-group="' + esc(g.id) + '">' +
