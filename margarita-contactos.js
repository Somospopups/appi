...
(function(){
  ...
  function css(){
    ...
    st.textContent = [
      '#view-margarita{min-height:100vh;background:radial-gradient(circle at 15% 4%,rgba(119,229,195,.32),transparent 24%),radial-gradient(circle at 90% 17%,rgba(116,173,245,.18),transparent 24%),linear-gradient(155deg,#f1fcf9,#e1f5f3 50%,#edf2ff)}',
      '.mg-wrap{max-width:1060px;margin:0 auto;padding:8px 14px calc(105px + env(safe-area-inset-bottom))}.mg-hero{display:flex;align-items:flex-start;justify-content:space-between;gap:20px;padding:12px 5px 15px}.mg-kicker{display:inline-flex;align-items:center;gap:6px;color:#0d8576;font-size:9px;font-weight:1000;letter-spacing:1px}.mg-kicker:before{content:"";width:18px;height:2px;border-radius:4px;background:#1bb49d}.mg-hero h2{margin:5px 0 0;color:#153a51;font-size:31px;line-height:1.04;letter-spacing:-1.25px}.mg-hero h2 em{font-style:normal;color:#119884}.mg-hero p{max-width:510px;margin:8px 0 0;color:#698292;font-size:12px;line-height:1.45;font-weight:650}.mg-hero-actions{display:flex;gap:7px;flex-wrap:wrap;justify-content:flex-end;padding-top:9px}.mg-chip{padding:7px 10px;border:1px solid rgba(30,101,116,.1);border-radius:999px;background:rgba(255,255,255,.67);color:#5d7887;font-size:9px;font-weight:900}.mg-chip b{color:#107f71}',
      '.mg-layout{display:grid;grid-template-columns:minmax(420px,1fr) minmax(265px,.55fr);gap:19px;align-items:center}.mg-garden{position:relative;min-height:518px;padding:16px;border:1px solid rgba(255,255,255,.9);border-radius:31px;background:linear-gradient(145deg,rgba(255,255,255,.84),rgba(241,255,251,.58));box-shadow:0 19px 48px rgba(20,76,92,.16);overflow:hidden}.mg-garden:before{content:"";position:absolute;inset:0;background-image:radial-gradient(rgba(24,130,118,.14) 1px,transparent 1px);background-size:17px 17px;opacity:.25;mask-image:linear-gradient(to bottom,black,transparent 80%)}.mg-garden-head{position:relative;z-index:2;display:flex;align-items:center;justify-content:space-between;gap:8px;padding:0 3px}.mg-garden-head b{color:#244657;font-size:13px}.mg-garden-head span{color:#708997;font-size:10px;font-weight:800}.mg-garden-head span strong{color:#119280}.mg-edit-groups{border:0;border-radius:10px;padding:7px 9px;background:#e7faf3;color:#108673;font:inherit;font-size:9px;font-weight:950;cursor:pointer}',
      '.mg-stage{position:relative;z-index:1;width:min(100%,505px);height:432px;margin:8px auto 0}.mg-orbit{position:absolute;left:50%;top:50%;width:346px;height:346px;transform:translate(-50%,-48%);border:1px dashed rgba(16,136,122,.2);border-radius:50%;animation:mgSpin 44s linear infinite}.mg-orbit:before,.mg-orbit:after{content:"";position:absolute;border-radius:50%;background:#70ddbd;box-shadow:0 0 0 5px rgba(112,221,189,.17)}.mg-orbit:before{width:7px;height:7px;left:17%;top:3%}.mg-orbit:after{width:5px;height:5px;right:8%;bottom:16%}@keyframes mgSpin{to{transform:translate(-50%,-48%) rotate(360deg)}}.mg-flower{position:absolute;left:50%;top:50%;width:0;height:0;transform:translate(-50%,-47%)}',
      '.mg-petal{position:absolute;left:-57px;top:-180px;width:114px;height:180px;padding:0;background:transparent;transform-origin:50% 100%;transform:rotate(var(--angle));clip-path:polygon(50% 0,73% 5%,92% 30%,96% 58%,78% 88%,50% 100%,22% 88%,4% 58%,8% 30%,27% 5%);filter:drop-shadow(0 10px 10px rgba(15,90,101,.13))}.mg-petal-shape{position:absolute;inset:0;border:1px solid rgba(35,108,125,.12);border-radius:58% 58% 50% 50% / 74% 74% 37% 37%;background:linear-gradient(145deg,#fff,#f8fefc 65%,#dff4ed);box-shadow:inset 0 2px 2px rgba(255,255,255,.9);transition:.25s;transform-origin:50% 100%;animation:mgPetalShapeIn .68s calc(var(--i)*.055s) cubic-bezier(.18,1.35,.4,1) both}.mg-petal:after{content:"";position:absolute;left:50%;bottom:11px;width:20px;height:20px;transform:translateX(-50%);border-radius:50%;background:rgba(129,224,191,.23);filter:blur(7px);transition:.25s}.mg-petal-content{position:absolute;z-index:1;left:10px;right:10px;top:12px;display:grid;justify-items:center;gap:4px;transform:rotate(var(--counter));color:#245469;text-align:center;transform-origin:50% 100%;animation:mgPetalContentIn .68s calc(var(--i)*.055s) cubic-bezier(.18,1.35,.4,1) both}.mg-petal-content i{display:grid;place-items:center;width:29px;height:29px;border-radius:10px;background:#e6faf4;color:#15947e;font-size:15px;font-style:normal}.mg-petal-content b{font-size:10.5px;line-height:1.08;letter-spacing:-.2px}.mg-petal-content small{display:flex;align-items:center;gap:3px;color:#71919b;font-size:8px;font-weight:850}.mg-petal-content small:before{content:"";width:5px;height:5px;border-radius:50%;background:#39c99c}.mg-petal:hover .mg-petal-shape,.mg-petal.has-contacts .mg-petal-shape{transform:translateY(-7px) scale(1.068);border-color:#60cdb4;background:linear-gradient(145deg,#fffef3,#effff9 66%,#d7f8ec)}.mg-petal:hover:after,.mg-petal.has-contacts:after{background:#f3bd3d}.mg-petal:hover .mg-petal-content i,.mg-petal.has-contacts .mg-petal-content i{background:#159d89;color:#fff}@keyframes mgPetalShapeIn{from{opacity:0;transform:scale(.35)}to{opacity:1;transform:scale(1)}}@keyframes mgPetalBreeze{50%{transform:translateY(-4px)}}@keyframes mgPetalContentIn{from{opacity:0;transform:rotate(var(--counter)) scale(.35)}to{opacity:1;transform:rotate(var(--counter)) scale(1)}}@keyframes mgPetalContentBreeze{50%{transform:rotate(var(--counter)) translateY(-4px)}}',
  ...
  function render(){
    ...
    var petals = state.grupos.map(function(g, i){
      ...
      var label = esc(g.label).replace(/\s+/g,'<br>');
      return '<button type="button" class="mg-petal ' + (count ? 'has-contacts' : '') + '" style="--angle:' + (i * 45) + 'deg;--counter:-' + (i * 45) + 'deg;--i:' + i + '" data-mg-group="' + esc(g.id) + '"><span class="mg-petal-shape"></span><span class="mg-petal-content"><i>' + esc(g.icon) + '</i><b>' + label + '</b><small>' + count + ' persona' + (count===1?'':'s') + '</small></span></button>';
    }).join('');
    host.innerHTML =
