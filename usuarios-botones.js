...
(function(){
  ...
  function css(){
    ...
    st.textContent = [
      ...
      'background:linear-gradient(135deg,#0b5878,#3ad0a4);color:#fff;font:inherit;font-size:12.5px;font-weight:800;',
      ...
      '.ub-main.on{background:linear-gradient(135deg,#0b5878,#3ad0a4);border-color:transparent;color:#fff;box-shadow:0 7px 18px rgba(91,112,210,.28)}',
      ...
      'background:linear-gradient(135deg,#0b5878,#3ad0a4);color:#fff;font-size:11px;font-weight:900}',
