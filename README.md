...
- Versión: **v831 · Segura** · 🔵 **Panel de Contactos a prueba de balas**: blindaje total contra la pantalla blanca en iOS (filas malformadas, errores de render y cola de agenda personal protegidos; el peor caso es un aviso con “Reintentar”, nunca un blanco). · Cache `appi-v831-panel-blindado`.
