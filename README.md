...
- Versión: **v804 · Segura** · 📋 Listado del día en el Home: la tarjeta Usuarios del mazo muestra SIEMPRE a toda la gente del día, persona por persona (como la tarjeta de reempadronamiento, sin botones por fila). Verde = ya la hice, roja = no la hice; el color refleja la marca de la tarea y queda a punto al volver al Home.
