...
- Versión: **v940 · Segura** · 📷🔩 **Canillas por foto**: sacás una foto o subís una imagen del adaptador y APPI la compara contra las fotos y números de la Guía V02-21 (OCR con tesseract + similitud de imagen) y te muestra las coincidencias con porcentaje. El modo guiado (uso → boca → medida) queda de respaldo. · Cache `appi-v940-foto`.
