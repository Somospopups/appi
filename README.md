...
- Versión: **v830 · Segura** · 🔵 **iOS sin pantalla blanca en el Panel de Contactos**: los listados grandes (Prioridad de hoy, Todos, Agenda personal) se pintan por tandas con botón “Mostrar más” (antes, con miles de contactos, un DOM de varios megas dejaba la pantalla blanca en iOS). Además: red de seguridad global de errores — cualquier fallo de script o promesa guarda un anillo (`appi_err_v1`) y muestra una barra roja con “Recargar”; nada vuelve a fallar en blanco silencio. · Cache `appi-v830-ios-panel`.
