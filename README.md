...
- Versión: **v832 · Segura** · 📸 **Foto de producto en la Lista de Precios**: los 63 productos que se venden en la tienda de PSA (todos los equipos principales y sus variantes) ahora se ven con su foto oficial (27 de 35 equipos), igual que en tienda.psa.com.ar. Las fotos ya se descargaban en `catalogo-img/` con el sync de precios; ahora el catálogo las lleva (`foto`) y la lista las pinta. El generador `build-catalogo-psa.mjs` conserva la foto en cada corrida automática. · Cache `appi-v832-lista-fotos`.
