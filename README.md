...
- Versión: **v938 · Segura** · 🔩 **Canillas y adaptadores (identificador asistido)**: la feature vuelve reconstruida — elegís uso, tipo de boca y medida y te deja el modelo justo de la Guía V02-21 (84 piezas, con foto oficial y SKU). Se recupera el gesto de atrás para los modales, la tarjeta del Home y el botón del menú. · Cache `appi-v938-canillas`.
