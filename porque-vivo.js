...
(function(){
  ...
  function estilo(){
    ...
    s.textContent = '' +
      ...
      '.pk-next{flex:1;border:0;border-radius:12px;padding:10px;background:linear-gradient(135deg,#3ad0a4,#128C7E);color:#fff;font:inherit;font-size:12.5px;font-weight:900;cursor:pointer}' +
