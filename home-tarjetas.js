...
(function(){
  ...
  function tarjetaHoyConviene(){
    ...
    var filas = [], items = [];
    gente.slice(0, 5).forEach(function(p){
  ...
  function tarjetaPanel(){
    ...
    var filas = [], items = [];
    nuevos.slice(0, 4).forEach(function(c){
  ...
  function tarjetaUsuarios(){
    try{
      ...
      var todas = r.pendientes === 0;
      var titulo = todas
        ? (r.noHechas === 0 ? '¡Todas hechas! Bien jugado' : 'Fin del día: ' + r.hechas + ' ✓ y ' + r.noHechas + ' ✗')
        : (r.pendientes === 1 ? 'Queda 1 de ' + r.total : 'Quedan ' + r.pendientes + ' de ' + r.total);
      return {
  ...
  function css(){
    ...
    st.textContent = [
      ...
      '.ht-lista li.ht-hecho{background:#6ee7b7 !important;color:#064e3b !important;border:1px solid #34d399 !important;font-weight:800 !important;text-decoration:none}',
      '.ht-lista li.ht-hecho::after{content:"✓";color:#168765}',
      'body.dark .ht-lista li.ht-hecho{background:#10b981 !important;color:#ecfdf5 !important;border:1px solid #34d399 !important;text-decoration:none}',
      'body.dark .ht-lista li.ht-hecho::after{color:#3ad0a4}',
      '.ht-lista li.ht-no-hecha{background:#fca5a5 !important;color:#7f1d1d !important;border:1px solid #ef4444 !important;font-weight:800 !important}',
      ...
      '.ht-psa-fab{position:absolute !important;top:12px !important;right:12px !important;left:auto !important;bottom:auto !important;z-index:10 !important;width:38px !important;height:38px !important;border-radius:50% !important;border:0 !important;background:#25D366 !important;color:#fff !important;display:grid !important;place-items:center !important;box-shadow:0 8px 18px rgba(0,0,0,.18) !important;cursor:pointer !important;transition:transform .12s !important;pointer-events:auto !important;transform:none !important}',
      ...
      'body.dark .ht-card.ht-esp{background:linear-gradient(150deg,#0e6a90,#0b5878 58%,#041f37)}',
      '.ht-card.ht-esp .ht-kicker{color:rgba(255,255,255,.9)}',
      '.ht-card.ht-esp h3{color:#fff;text-shadow:0 1px 6px rgba(20,20,60,.25)}',
      '.ht-card.ht-esp .ht-cuerpo{display:flex;flex-direction:column;justify-content:flex-start;gap:8px;flex:1 1 auto;min-height:0}',
      '.ht-esp-centro{margin:0;flex:1 1 auto;display:flex;flex-direction:column;justify-content:center;align-items:stretch;position:relative;padding:0;min-height:0}',
      ...
      '.ht-card.ht-esp .ht-chips{margin-top:auto;margin-bottom:0;flex:0 0 auto}',
      ...
      '.ht-card.ht-poster,.ht-card.ht-poster.ht-esp,.ht-card.ht-poster.ht-hoy,.ht-card.ht-poster.ht-alerta,.ht-card.ht-poster.ht-ganaste{overflow:hidden;color:#fff;border:0}',
      'body:not(.dark) .ht-card.ht-poster::after{content:\"\";position:absolute;inset:0;border-radius:inherit;background:rgba(0,0,0,.28);pointer-events:none}',
      'body:not(.dark) .ht-card.ht-poster>:not(.ht-marca){position:relative;z-index:1}',
      'body:not(.dark) .ht-card.ht-poster .ht-marca,.ht-card.ht-poster .ht-marca{position:absolute;right:-8px;bottom:-18px;z-index:0;font-size:118px;line-height:1;opacity:.18;pointer-events:none}',
      'body .ht-card.ht-poster .ht-kicker,body .ht-card.ht-poster.ht-esp .ht-kicker,body .ht-card.ht-poster.ht-hoy .ht-kicker,body .ht-card.ht-poster.ht-alerta .ht-kicker,body .ht-card.ht-poster.ht-ganaste .ht-kicker{color:#fff}',
      'body:not(.dark) .ht-card.ht-poster .ht-kicker,body:not(.dark) .ht-card.ht-poster.ht-hoy .ht-kicker,body:not(.dark) .ht-card.ht-poster.ht-alerta .ht-kicker,body:not(.dark) .ht-card.ht-poster.ht-ganaste .ht-kicker,body:not(.dark) .ht-card.ht-poster.ht-esp .ht-kicker{color:#fff;text-shadow:0 1px 1px rgba(0,0,0,.7),0 0 10px rgba(0,0,0,.45)}',
      'body .ht-card.ht-poster h3,body .ht-card.ht-poster.ht-esp h3,body .ht-card.ht-poster.ht-hoy h3,body .ht-card.ht-poster.ht-alerta h3,body .ht-card.ht-poster.ht-ganaste h3{color:#fff;text-shadow:0 1px 2px rgba(0,0,0,.55),0 2px 12px rgba(0,0,0,.35)}',
      'body:not(.dark) .ht-card.ht-poster h3,body:not(.dark) .ht-card.ht-poster.ht-esp h3,body:not(.dark) .ht-card.ht-poster.ht-hoy h3,body:not(.dark) .ht-card.ht-poster.ht-alerta h3,body:not(.dark) .ht-card.ht-poster.ht-ganaste h3{color:#fff;text-shadow:0 1px 1px rgba(0,0,0,.75),0 2px 14px rgba(0,0,0,.5)}',
      'body .ht-card.ht-poster .ht-frase,body .ht-card.ht-poster .ht-esp-frase,body .ht-card.ht-poster.ht-alerta .ht-frase,body .ht-card.ht-poster.ht-hoy .ht-frase,body .ht-card.ht-poster.ht-ganaste .ht-frase{color:#fff}',
      'body:not(.dark) .ht-card.ht-poster .ht-frase,body:not(.dark) .ht-card.ht-poster .ht-esp-frase,body:not(.dark) .ht-card.ht-poster.ht-alerta .ht-frase{color:#fff;text-shadow:0 1px 2px rgba(0,0,0,.65)}',
      'body .ht-card.ht-poster .ht-lista li,body .ht-card.ht-poster.ht-hoy .ht-lista li,body .ht-card.ht-poster.ht-alerta .ht-lista li{background:rgba(0,0,0,.28);color:#fff}',
      'body:not(.dark) .ht-card.ht-poster .ht-lista li{background:rgba(0,0,0,.38);color:#fff}',
      'body .ht-card.ht-poster .ht-lista li:hover{background:rgba(0,0,0,.4)}',
      'body .ht-card.ht-poster .ht-lista li::after,body .ht-card.ht-poster .ht-lista li i{color:#fff}',
      'body .ht-card.ht-poster .ht-lista li.ht-hecho{background:rgba(0,0,0,.32);color:#fff}',
      'body .ht-card.ht-poster .ht-lista li.ht-hecho::after{color:#fff}',
      'body .ht-card.ht-poster .ht-nota,body .ht-card.ht-poster.ht-alerta .ht-nota{color:#fff}',
      'body:not(.dark) .ht-card.ht-poster .ht-nota{color:#fff;text-shadow:0 1px 2px rgba(0,0,0,.6)}',
      'body .ht-card.ht-poster .ht-pasos li,body .ht-card.ht-poster.ht-alerta .ht-pasos li{background:rgba(0,0,0,.28);color:#fff}',
      'body:not(.dark) .ht-card.ht-poster .ht-pasos li,body:not(.dark) .ht-card.ht-poster.ht-alerta .ht-pasos li{background:rgba(0,0,0,.38);color:#fff}',
      ...
      '.ht-card.ht-poster.ht-cat-especial,body.dark .ht-card.ht-poster.ht-cat-especial{background:linear-gradient(150deg,#0e6a8c,#0b5878) !important;box-shadow:0 22px 60px rgba(11,88,120,.38) !important}',
      '.ht-card.ht-poster.ht-cat-hoy,body.dark .ht-card.ht-poster.ht-cat-hoy{background:linear-gradient(150deg,#8a6410,#6b4e0c) !important;border:0;box-shadow:0 22px 60px rgba(107,78,12,.4) !important}',
      '.ht-card.ht-poster.ht-cat-ganaste,body.dark .ht-card.ht-poster.ht-cat-ganaste,.ht-card.ht-poster.ht-cat-llegamos,body.dark .ht-card.ht-poster.ht-cat-llegamos{background:linear-gradient(150deg,#157a60,#0f5a46) !important;border:0;box-shadow:0 22px 60px rgba(15,90,70,.4) !important}',
      '.ht-card.ht-poster.ht-cat-metodo,body.dark .ht-card.ht-poster.ht-cat-metodo{background:linear-gradient(150deg,#b03e12,#8e2e0e) !important;border:0;box-shadow:0 22px 60px rgba(142,46,14,.4) !important}',
      '.ht-card.ht-poster.ht-cat-canje,body.dark .ht-card.ht-poster.ht-cat-canje{background:linear-gradient(150deg,#3d63c9,#2c4aa3) !important}',
      '.ht-card.ht-poster.ht-cat-jornada,body.dark .ht-card.ht-poster.ht-cat-jornada{background:linear-gradient(150deg,#8a6410,#6b4e0c) !important}',
      '.ht-card.ht-poster.ht-cat-oportunidades,body.dark .ht-card.ht-poster.ht-cat-oportunidades{background:linear-gradient(150deg,#7a2e7a,#5e225e) !important}',
      '.ht-card.ht-poster.ht-cat-cumples,body.dark .ht-card.ht-poster.ht-cat-cumples{background:linear-gradient(150deg,#9a2d58,#7a2145) !important}',
      '.ht-card.ht-poster.ht-cat-reempadronar,body.dark .ht-card.ht-poster.ht-cat-reempadronar{background:linear-gradient(150deg,#2f5d4a,#234538) !important}',
      '.ht-card.ht-poster.ht-cat-equipo,body.dark .ht-card.ht-poster.ht-cat-equipo{background:linear-gradient(150deg,#1f4e79,#173a5a) !important}',
      '.ht-card.ht-poster.ht-cat-panel,body.dark .ht-card.ht-poster.ht-cat-panel{background:linear-gradient(150deg,#3a4a6b,#2c3852) !important}',
      '.ht-card.ht-poster.ht-cat-usuarios,body.dark .ht-card.ht-poster.ht-cat-usuarios{background:linear-gradient(150deg,#6d28d9,#4c1d95) !important}',
      '.ht-card.ht-poster.ht-cat-rinnova,body.dark .ht-card.ht-poster.ht-cat-rinnova{background:linear-gradient(150deg,#7f1d1d,#5b1313) !important}',
      '.ht-card.ht-poster.ht-cat-promo,body.dark .ht-card.ht-poster.ht-cat-promo{background:linear-gradient(150deg,#0e6a8c,#0b5878 58%,#1a9ab0) !important;border:0;box-shadow:0 22px 60px rgba(14,106,140,.34) !important}',
      '.ht-card.ht-poster.ht-cat-otra,body.dark .ht-card.ht-poster.ht-cat-otra{background:linear-gradient(150deg,#0e6a8c,#0b5878) !important}',
  ...
  function coverPuedeMover(){
    if (!mazo || mazo.coverBusy) return false;
    mazo.coverBusy = true;
    setTimeout(function(){ if (mazo) mazo.coverBusy = false; }, 620);
    return true;
  }
  ...
  function irACover(k){
    ...
    var len = mazo.tarjetas.length;
    if (!len) return;
    mazo.i = ((k % len) + len) % len;
    pintarCover(false);
  }
  function pintarCover(deal){
    if (!mazo) return;
    var deck = document.getElementById('htDeck');
    ...
    if (!mazo.coverDOM || deck.getAttribute('data-cover') !== '1' || deck.querySelectorAll('.ht-card').length !== len){
      deck.innerHTML = '';
      deck.setAttribute('data-cover', '1');
      mazo.tarjetas.forEach(function(t, k){
        var el = crearCarta(t);
  ...
  function pasar(){
    ...
    if (esPC()){ if (!coverPuedeMover()) return false; mazo.i = (mazo.i + 1) % len; pintarCover(false); return true; }
    var deck = document.getElementById('htDeck');
  ...
  function volver(){
    ...
    if (esPC()){ if (!coverPuedeMover()) return false; mazo.i = (mazo.i - 1 + mazo.tarjetas.length) % mazo.tarjetas.length; pintarCover(false); return true; }
    var deck = document.getElementById('htDeck');
    var top = deck && deck.querySelector('.ht-card:not(.detras1):not(.detras2):not(.ht-fantasma)');
    if (top){
  ...
  function envolver(){
    ...
    if (!window.__htCoverMq && window.matchMedia){
      window.__htCoverMq = window.matchMedia('(min-width:1024px)');
      var onMq = function(){ try{ if (mazo && esHome()){ mazo.coverDOM = false; mazo.coverDeal = false; pintar(); } }catch(e){} };
      if (window.__htCoverMq.addEventListener) window.__htCoverMq.addEventListener('change', onMq);
      else if (window.__htCoverMq.addListener) window.__htCoverMq.addListener(onMq);
    }
