...
(function(){
  ...
  function css(){
    ...
    st.textContent = [
      ...
      'body .ht-card.ht-poster h3,body .ht-card.ht-poster.ht-esp h3,body .ht-card.ht-poster.ht-hoy h3,body .ht-card.ht-poster.ht-alerta h3,body .ht-card.ht-poster.ht-ganaste h3{color:#fff;text-shadow:0 1px 2px rgba(0,0,0,.45),0 2px 12px rgba(0,0,0,.28)}',
      ...
      'body .ht-card.ht-poster .ht-lista li,body .ht-card.ht-poster.ht-hoy .ht-lista li,body .ht-card.ht-poster.ht-alerta .ht-lista li{background:rgba(0,0,0,.22);color:#fff}',
      'body .ht-card.ht-poster .ht-lista li:hover{background:rgba(0,0,0,.3)}',
      'body .ht-card.ht-poster .ht-lista li::after,body .ht-card.ht-poster .ht-lista li i{color:#fff}',
      'body .ht-card.ht-poster .ht-lista li.ht-hecho{background:rgba(0,0,0,.28);color:#fff}',
      ...
      'body .ht-card.ht-poster .ht-pasos li,body .ht-card.ht-poster.ht-alerta .ht-pasos li{background:rgba(0,0,0,.22);color:#fff}',
      'body .ht-card.ht-poster .ht-chips span,body .ht-card.ht-poster.ht-esp .ht-chips span{background:rgba(0,0,0,.22);color:#fff;border:1px solid rgba(255,255,255,.35)}',
