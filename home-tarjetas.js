...
(function(){
  ...
  function css(){
    ...
    st.textContent = [
      ...
      '.ht-card.ht-poster.ht-cat-hoy,body.dark .ht-card.ht-poster.ht-cat-hoy{background:linear-gradient(150deg,#8a6410,#6b4e0c);border:0;box-shadow:0 22px 60px rgba(107,78,12,.4)}',
