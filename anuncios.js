...
(function(){
  ...
  function estilos(){
    ...
    st.textContent = [
      ...
      'font-size:22px;background:linear-gradient(135deg,#0b5878,#3ad0a4);box-shadow:0 8px 20px rgba(91,141,239,.35)}',
      ...
      '.an-b-appi{background:linear-gradient(135deg,#0b5878,#3ad0a4);color:#fff;box-shadow:0 7px 16px rgba(91,141,239,.3)}',
