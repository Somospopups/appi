...
function categoryPB(period,category){const targetRank=HIST_CAT_RANK[category];if(targetRank==null)return 0;return period.people.reduce((sum,person)=>{const rank=HIST_CAT_RANK[person.cat];return rank!=null&&rank<=targetRank?sum+num(person.pnAct):sum},0)}
