...
(function(){
  ...
  function css(){
    ...
    st.textContent = [
      ...
      'body.dark .mu-sec-titulo{color:#a0e6d0}',
      ...
      'background:linear-gradient(135deg,rgba(91,141,239,.11),rgba(58,208,164,.1))}',
      ...
      'background:linear-gradient(135deg,#0b5878,#3ad0a4);color:#fff;font-size:12px;font-weight:900;white-space:nowrap}',
      ...
      'body.dark #muHoy{background:linear-gradient(135deg,rgba(91,141,239,.16),rgba(58,208,164,.14));border-color:rgba(255,255,255,.1)}',
      ...
      '.action-btn.msg{background:rgba(58,208,164,.14);color:#6f3fd0;border-color:rgba(58,208,164,.22)}',
